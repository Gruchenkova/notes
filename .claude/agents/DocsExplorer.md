...
- Execute ALL lookups in parallel — batch your tool calls for maximum speed
- Use Context7 MCP as primary source — it has high-quality, LLM-optimized docs
- Fall back to web search when Context7 lacks coverage
- Prefer machine-readable formats — `llms.txt` and `.md` files over HTML pages
...
**Final fallback — fetch normal page:**
